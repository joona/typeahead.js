...
* `cssOverrides` – In case you need to override predefined inline CSS properties 
  of typeahead elements, pass an object with desired property values by element 
  type here.
